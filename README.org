...
When using ="Gehan corrected"= or ="Peron corrected"= in presence of
censoring, some pairs may be classified as uninformative. This is
likely to bias the estimate of the net survival. Two corrections are
currently proposed to correct this bias.
...
BuyseTest(Treatment ~ tte(eventtimeUncensored, status1, threshold = 1),
          data = dt,
          method.tte = "Gehan", method.inference = "none")
#+END_SRC
...
BT <- BuyseTest(Treatment ~ tte(eventtime, status, threshold = 1),
                data = dt, keep.pairScore = TRUE,
                method.tte = "Gehan IPCW", method.inference = "none")
summary(BT)
#+END_SRC
...
: 1:         0           0       0             1      1     501       1      1            0.000000              0.000000          0.000000
: 2:         0           0       1             0      1     504       1      1            0.000000              0.000000          1.939007
: 3:         0           1       0             0      1     504      24      1            0.000000              1.939007          0.000000
: 4:         1           0       0             0      1     505       1      1            1.939007              0.000000          0.000000
...
BT <- BuyseTest(Treatment ~ tte(eventtime, status, threshold = 1),
                data = dt, keep.pairScore = TRUE,
                method.tte = "Gehan corrected", method.inference = "none")
summary(BT)
#+END_SRC
