...
#+begin_example
 ...
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta
     time        20   100     37.78       46.55      15  0.66 -0.0877 -0.0877
#+end_example
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf  delta  Delta
     time        20   100     37.78       46.55      15  0.66 0.8116 0.8116
#+end_example
...
#+begin_example
 ...
 endpoint threshold    strata  total favorable unfavorable neutral uninf   delta   Delta
     time        20    global 100.00     36.06       45.77   16.92  1.25 -0.0971 -0.0971
                     squamous  25.38     14.33        8.77    2.03  0.25  0.0557      NA
                    smallcell  45.69     12.69       20.88   11.25  0.86 -0.0819      NA
                        adeno  13.71      4.74        6.15    2.71  0.11 -0.0142      NA
                        large  15.23      4.30        9.97    0.93  0.03 -0.0567      NA
    karno     1e-12    global  18.17      6.72        8.07    3.38  0.00 -0.0135 -0.1106
                     squamous   2.28      0.76        0.94    0.59  0.00 -0.0018      NA
                    smallcell  12.12      4.33        5.75    2.03  0.00 -0.0142      NA
                        adeno   2.81      1.46        0.85    0.51  0.00  0.0061      NA
                        large   0.96      0.17        0.54    0.25  0.00 -0.0037      NA
#+end_example
...
#+begin_example
 ...
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.55      15  0.66 -0.0877 -0.0877 [-0.2412;0.1946]     0.4 
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.55      15  0.66 -0.0877 -0.0877 [-0.1796;0.0301]     0.5
#+end_example
...
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
keep.cols <- c("index.2", "index.1", "favorable", "unfavorable", "neutral", "uninformative")
BT.keep@tableComparison[[1]][c(1:2,90:91),.SD,.SDcols = keep.cols]
#+END_SRC

#+RESULTS:
:    index.2 index.1 favorable unfavorable neutral uninformative
: 1:      70       1         1   0.0000000       0    0.00000000
: 2:      70       2         1   0.0000000       0    0.00000000
: 3:      71      21         0   0.9166667       0    0.08333333
: 4:      71      22         0   0.6950827       0    0.30491728
...
dt.tempo[index.2==71 & index.1==22, .SD, .SDcols = keep.cols]
#+END_SRC

#+RESULTS:
:    index.2 index.1 favorable unfavorable neutral uninformative
: 1:      71      22 0.3049173           0       0             0

Since 80 > 60, the rest of the weight relative to the pair is
transferred to the favorable category.

** GPC with time to event outcomes in presence of censoring
GPC is based on our ability to rank the values taken for a given
outcome in the control vs. the treatment group. This is 
