...
locale:
 [1] LC_CTYPE=fr_FR.UTF-8       LC_NUMERIC=C               LC_TIME=da_DK.UTF-8        LC_COLLATE=fr_FR.UTF-8    
 [5] LC_MONETARY=da_DK.UTF-8    LC_MESSAGES=fr_FR.UTF-8    LC_PAPER=da_DK.UTF-8       LC_NAME=C                 
...
[1] testthat_2.0.0     BuyseTest_1.3.1    data.table_1.11.0  Rcpp_0.12.16       prodlim_2018.04.18

loaded via a namespace (and not attached):
 [1] lattice_0.20-35 grid_3.4.1      R6_2.2.2        stats4_3.4.1    magrittr_1.5    rlang_0.2.0     Matrix_1.2-11  
 [8] lava_1.6.1      splines_3.4.1   tools_3.4.1     survival_2.41-3 parallel_3.4.1  compiler_3.4.1
#+end_example
