...
#+begin_example
 ...
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta
     time        20   100     37.78       46.54      15  0.68 -0.0876 -0.0876
#+end_example
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf  delta  Delta
     time        20   100     37.78       46.54      15  0.68 0.8117 0.8117
#+end_example
...
#+begin_example
 ...
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.54      15  0.68 -0.0876 -0.0876 [-0.2411;0.1947]     0.4 
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.54      15  0.68 -0.0876 -0.0876 [-0.1794;0.0302]     0.5
#+end_example
...
: 1:      1      70       1                   1                   1         1   0.0000000       0    0.00000000    1
: 2:      1      70       2                   1                   2         1   0.0000000       0    0.00000000    1
: 3:      1      71      21                   2                  21         0   0.9166667       0    0.08333333    1
: 4:      1      71      22                   2                  22         0   0.6950827       0    0.30491728    1
...
#+RESULTS:
:    strata index.2 index.1 indexWithinStrata.2 indexWithinStrata.1 favorable unfavorable neutral uninformative IPCW
: 1:      1      71      22                   2                  22 0.3049173           0       0             0    1
...
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
BT.keep <- BuyseTest(trt ~ tte(time, threshold = 20, censoring = "status"), ##+ cont(karno),
                     data = veteran, keep.comparison = TRUE, method.tte = "Gehan corrected",
                     trace = 0, method.inference = "none")
summary(BT.keep)
#+END_SRC
...
[1] BuyseTest_1.3.4     data.table_1.10.4-3 Rcpp_0.12.17        prodlim_1.6.1      

loaded via a namespace (and not attached):
 [1] lattice_0.20-35 grid_3.4.0      R6_2.2.1        stats4_3.4.0    magrittr_1.5    rlang_0.2.0     testthat_2.0.0  Matrix_1.2-9    lava_1.6.1     
[10] splines_3.4.0   tools_3.4.0     survival_2.41-3 parallel_3.4.0  compiler_3.4.0
#+end_example
