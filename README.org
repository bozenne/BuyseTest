...
library(BuyseTest, quietly = TRUE, verbose = FALSE)
#+END_SRC
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.54      15  0.68 -0.0876 -0.0876 [-0.1794;0.0302]     0.7
#+end_example
...
[1] testthat_2.0.0      BuyseTest_1.3.2     data.table_1.10.4-3 Rcpp_0.12.16        prodlim_1.6.1      

loaded via a namespace (and not attached):
 [1] lattice_0.20-35 grid_3.4.0      R6_2.2.1        stats4_3.4.0    magrittr_1.5    rlang_0.2.0     Matrix_1.2-9    lava_1.6.1      splines_3.4.0  
