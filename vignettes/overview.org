...
- *permutation test* setting the argument =method.inference= to
  ="permutation"=. This approach gives valid p-values but not valid
...
- normal approximation setting the argument =method.inference= to
  ="u-statistic"=. In large enougth samples and for the Gehan scoring rule, this approach gives valid
  p-values and confidence intervals.
...
[1] data.table_1.12.0  BuyseTest_1.7.5    Rcpp_1.0.0         prodlim_2018.04.18

loaded via a namespace (and not attached):
 [1] magrittr_1.5         splines_3.5.1        MASS_7.3-50          lattice_0.20-35     
 [5] R6_2.3.0             rlang_0.3.1          multcomp_1.4-8       stringr_1.3.1       
 [9] tools_3.5.1          parallel_3.5.1       grid_3.5.1           KernSmooth_2.23-15  
[13] TH.data_1.0-9        htmltools_0.3.6      survival_2.42-6      yaml_2.2.0          
[17] digest_0.6.17        Matrix_1.2-14        lava_1.6.4           codetools_0.2-15    
[21] profvis_0.3.5        microbenchmark_1.4-5 htmlwidgets_1.3      testthat_2.0.0      
[25] sandwich_2.5-0       stringi_1.2.4        compiler_3.5.1       stats4_3.5.1        
[29] jsonlite_1.5         mvtnorm_1.0-8        zoo_1.8-4
#+end_example
