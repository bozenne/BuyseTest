...
Error in eval(bysub, x, parent.frame()) : 
  objet 'uninformative' introuvable
1: powerBuyseTest(sim = simBuyseTest, sample.size = c(100), n.rep = 2, 
       formula = Treatment ~ tte(eventtime, censoring = status), 
       method.inference = "asymptotic", trace = 4)
2: do.call(method.loop, args = list(X = 1:n.rep, FUN = function(X) {
       return(warper(i = X, envir = envirBT))
   })) at powerBuyseTest.R#310
3: (function (X, FUN, ..., cl = NULL) 
   {
       FUN <- match.fun(FUN)
       if (!is.vector(X) || is.object(X)) 
           X <- as.list(X)
    ...
4: lapply(X[Split[[i]]], FUN, ...)
5: FUN(X[[i]], ...)
6: warper(i = X, envir = envirBT) at powerBuyseTest.R#313
7: inferenceUstatistic(tableSample, count.favorable = matrix(MresSample[, 
       "favorable"], nrow = 1), count.unfavorable = matrix(MresSample[, 
       "unfavorable"], nrow = 1), n.pairs = envir$sample.sizeC[iSample] * 
       envir$sample.sizeT[iSample], n.C = envir$sample.sizeC[iSample], 
       n.T = envir$sample.sizeT[iSample], n.strata = envir$outArgs$n.strata, 
    ... at powerBuyseTest.R#267
8: tablePairScore[[1]][, .SD, .SDcols = keep.col] at BuyseTest-inference.R#116
9: `[.data.table`(tablePairScore[[1]], , .SD, .SDcols = keep.col) at BuyseTest-inference.R#116
10: stop("Some items of .SDcols are not column names (or are NA)")
#+end_example
...
: Error in eval(bysub, x, parent.frame()) : 
:   objet 'uninformative' introuvable
: 1: iScore[, .SD[1], by = c("favorable", "unfavorable", "neutral", 
:        "uninformative")]
: 2: `[.data.table`(iScore, , .SD[1], by = c("favorable", "unfavorable", 
...
#+RESULTS:
: Error in weighted.mean.default(favorable, w = 1 - uninformative) : 
:   objet 'uninformative' introuvable
: 1: iScore[, .SD[1], by = c("favorable", "unfavorable", "neutral", 
:        "uninformative")]
: 2: `[.data.table`(iScore, , .SD[1], by = c("favorable", "unfavorable", 
...
* Control of the type 1 error with method.inference="asymptotic"     :noexport:
...
1:  10  10         1000   1000      0.009000     0.23128 0.19946          0.136
2:  50  50         1000   1000      0.002960     0.10010 0.09795          0.059
3: 100 100         1000   1000     -0.000320     0.07148 0.07001          0.058
4: 250 250         1000   1000      0.000116     0.04421 0.04454          0.047

 > statistic   : win ratio
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10          999    999         1.792      2.5160  1.6193        0.09529
2:  50  50         1000   1000         1.100      0.4736  0.4406        0.05900
3: 100 100         1000   1000         1.041      0.3040  0.2944        0.05800
4: 250 250         1000   1000         1.016      0.1831  0.1818        0.04700
#+end_example
...
#+begin_example
 ...
 > statistic   : net benefit
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10         1000   1000      0.003200     0.26476 0.22887          0.154
2:  50  50         1000   1000      0.003960     0.11893 0.11304          0.088
3: 100 100         1000   1000      0.001225     0.08362 0.08080          0.072
4: 250 250         1000   1000      0.001442     0.05124 0.05143          0.053

 > statistic   : win ratio
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10         1000   1000         1.188      0.7760  0.5938          0.070
2:  50  50         1000   1000         1.037      0.2515  0.2380          0.058
3: 100 100         1000   1000         1.017      0.1722  0.1655          0.061
4: 250 250         1000   1000         1.008      0.1036  0.1040          0.048
#+end_example
...
#+begin_example
 ...
 > statistic   : net benefit
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10         1000    999    -0.0004700     0.15699 0.12808         0.1304
2:  50  50         1000   1000    -0.0001364     0.06853 0.06497         0.0680
3: 100 100         1000   1000    -0.0000684     0.04643 0.04654         0.0480
4: 250 250         1000   1000     0.0007478     0.02898 0.02969         0.0410

 > statistic   : win ratio
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10          969    960         1.758      2.7763  1.3263          0.125
2:  50  50         1000   1000         1.109      0.5302  0.4519          0.054
3: 100 100         1000   1000         1.042      0.2994  0.2959          0.044
4: 250 250         1000   1000         1.020      0.1795  0.1827          0.041
#+end_example
...
#+begin_example
 ...
 > statistic   : net benefit
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10         1000   1000     -0.017681     0.20758 0.17780          0.159
2:  50  50         1000   1000     -0.003233     0.11382 0.08818          0.144
3: 100 100         1000   1000     -0.002893     0.09407 0.06290          0.195
4: 250 250         1000   1000     -0.001917     0.08100 0.04007          0.334

 > statistic   : win ratio
   n.T n.C rep.estimate rep.se mean.estimate sd.estimate mean.se rejection.rate
1:  10  10         1000   1000         1.060      0.4818 0.40423          0.111
2:  50  50         1000   1000         1.021      0.2449 0.18721          0.127
3: 100 100         1000   1000         1.013      0.1993 0.13183          0.188
4: 250 250         1000   1000         1.010      0.1705 0.08355          0.330
#+end_example
