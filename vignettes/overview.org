...
#+begin_example
 ...
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     37.78       46.54   15.68     0 -0.0877 -0.0877 [-0.1802;0.0248]     0.2
#+end_example

For the Gehan scoring rule, setting the argument =method.inference= to
="bootstrap"= when calling =BuyseTest= lead 
a direct calculation of the
variance of the net benefit is feasible. This is obtain
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
...
#+begin_example
 ...
 > results
 endpoint threshold total favorable unfavorable neutral uninf   delta   Delta  CI [2.5 ; 97.5] p.value 
     time        20   100     34.93        44.1      15  5.97 -0.0916 -0.0916 [-0.2708;0.0936]  0.3323
#+end_example
