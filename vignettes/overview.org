...
Two additional functions are presented in this document: =simBuyseTest=
...
intervals or p.values when calling the =summary= method. See
=help(BuyseRes-summary)= for more detailed explanations about the
...
#+begin_example
 ...
 > neutral pairs   : ignored at lower priority endpoints
 > results
 endpoint threshold weight total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)   delta   Delta
     time        20      1      100        37.78          46.54      15.68        0 -0.0877 -0.0877
    karno     1e-12      1      100        41.82          44.95      13.24        0 -0.0313 -0.1190
#+end_example
...
#+begin_example
 ...
 > results
 endpoint threshold weight total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)   delta   Delta
     time        20    0.8      100        37.78          46.54      15.68        0 -0.0877 -0.0701
    karno     1e-12    0.2      100        41.82          44.95      13.24        0 -0.0313 -0.0764
#+end_example
...
- *permutation test* setting the argument =method.inference= to
  ="permutation"=. This approach gives valid p-values.
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
...
- normal approximation setting the argument =method.inference= to
  ="u-statistic"=. In large enough samples and for the Gehan scoring rule, this approach gives valid
  p-values and confidence intervals.
...
#+begin_example
 ...
 endpoint threshold total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)   delta   Delta
     time        20      100        34.93           44.1         15     5.97 -0.0916 -0.0916
 p.value   CI [2.5 ; 97.5]
 0.33233  [-0.2708;0.0936]
#+end_example

The last method is the fastest since it requires very little extra
computation compared to the classical GPC. The first two approaches
require simulating a large number of samples and applying the GPC to
each of these samples. The number of samples is set using the arugment
=n.resampling= and it should typically be 10000. 
...
#+RESULTS:
:    index.1 index.2 indexWithinStrata.1 indexWithinStrata.2 favorable unfavorable   neutral uninf
: 1:      22      71                  22                   2         0   0.6950827 0.3049173     0
:    weight favorableC unfavorableC  neutralC uninfC
: 1:      1          0    0.6950827 0.3049173      0
...
#+RESULTS:
:                time SurvivalC-threshold         SurvivalC_0 SurvivalC+threshold SurvivalT-threshold 
:          97.0000000           0.5615232           0.5171924           0.4235463           0.4558824 
:         SurvivalT_0 SurvivalT+threshold 
:           0.3643277           0.2827500
...
#+RESULTS:
:                time SurvivalC-threshold         SurvivalC_0 SurvivalC+threshold SurvivalT-threshold 
:         112.0000000           0.5319693           0.4549201           0.3594915           0.3801681 
:         SurvivalT_0 SurvivalT+threshold 
:           0.2827500           0.2827500
...
#+RESULTS:
:    index.1 index.2 indexWithinStrata.1 indexWithinStrata.2 favorable unfavorable   neutral uninf
: 1:      10      72                  10                   3 0.5058685   0.3770426 0.1170889     0
:    weight favorableC unfavorableC  neutralC uninfC
: 1:      1  0.5058685    0.3770426 0.1170889      0
...
4: package 'lava' was built under R version 3.5.3 
5: In normalizePath(path.expand(path), winslash, mustWork) :
  path[1]="C:/Users/hpl802/Documents/GitHub/BuyseTest/src/../inst/include": The system cannot find the file specified
...
[1] lava_1.6.5         doParallel_1.0.15  iterators_1.0.12   foreach_1.4.7      data.table_1.12.2 
[6] BuyseTest_1.7.9    Rcpp_1.0.1         prodlim_2018.04.18
...
[31] backports_1.1.4           ps_1.1.0                  splines_3.5.1            
[34] usethis_1.4.0             assertthat_0.2.1          KernSmooth_2.23-15       
[37] crayon_1.3.4
#+end_example
