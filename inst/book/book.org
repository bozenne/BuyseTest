...
#+RESULTS:
:              estimate        se  lower.ci  upper.ci null   p.value
: toxicity.num   0.4632 0.0280893 0.4088112 0.5184788  0.5 0.1917665


#+BEGIN_SRC R :exports both :results output :session *R* :cache no
eToxPerm.BT <- BuyseTest(treatment ~ cont(toxicity.num, operator = "<0"),
                         data=dt.data, method.inference = "studentized permutation",
                         cpus = 5, seed = 10, n.resampling = 10000, trace = FALSE)
confint(eToxPerm.BT, statistic = "favorable")
#+END_SRC

#+RESULTS:
:              estimate         se  lower.ci  upper.ci null   p.value
: toxicity.num  0.35385 0.02808395 0.3020599 0.4094743  0.5 0.1242876
: Warning message:
: In .local(object, ...) :
...
data:  toxicity.num by treatment
Mann-Whitney estimate = 0.5368, tie factor = 0.94003, p-value =
0.1893
...
:  toxicity.num         2      100        19.44          22.14      58.41
...
#+begin_example
 ...
 toxicity.num global      100        35.43          42.74      21.83
...
#+RESULTS:
: Indlæser krævet navnerum: riskRegression
