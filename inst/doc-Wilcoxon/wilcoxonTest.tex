...
\label{sec:org031a3ea}

\subsection{Exact test}
\label{sec:org54c347f}
...
and an approximate test is performed instead, which assumes a normally
...
\begin{verbatim}
	...
	Wilcoxon-Mann-Whitney test (confidence interval requires proportional
	odds assumption, but test does not)
...
For a more generally applicable inference method resampling can be used:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
eperm.BT2 <- BuyseTest(group ~ cont(value), data = df2, add.halfNeutral = TRUE,
                       method.inference = "permutation", n.resampling = 1e4,
...
b-a=0 0.4090909 0.1542200 0.56434599   0.9289217
c-a=0 0.4375000 0.1465755 0.67306460   0.9752168
d-a=0 0.2500000 0.1010153 0.04143057   0.1227273
e-a=0 0.3333333 0.1360828 0.25767454   0.5831857
\end{verbatim}
