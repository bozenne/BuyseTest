...
\label{sec:org4c8de65}

\subsection{Theory}
\label{sec:orgd8fff2d}
\begin{align*}
...
\label{sec:org35cdf4a}

\subsection{Theory}
\label{sec:org7ca799f}
...
\section{Survival}
\label{sec:org274f0b2}

\subsection{Theory}
\label{sec:org0189822}
...
\label{sec:orge05c83f}

\subsection{Theory}
\label{sec:org21498cc}

\subsubsection{General case (no censoring)}
\label{sec:org6c02d90}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org44afb7e}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orgc6dff55}
