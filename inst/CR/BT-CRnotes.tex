...
\label{sec:org722bfe9}

\subsection{Theory}
\label{sec:orgd1e2934}
\begin{align*}
...
\label{sec:org55f4baf}

\subsection{Theory}
\label{sec:org5d3cc18}
...
\section{Survival}
\label{sec:org3f25ff8}

\subsection{Theory}
\label{sec:org83151e6}
...
\label{sec:orgf534bfe}

\subsection{Theory}
\label{sec:orgd9ead0d}

\subsubsection{General case (no censoring)}
\label{sec:org7646e55}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org7473e8f}

\subsubsection{BuyseTest (no censoring)}
\label{sec:org5a9f248}
