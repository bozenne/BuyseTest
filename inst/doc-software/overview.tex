...
[1] data.table_1.14.2  BuyseTest_2.3.6    Rcpp_1.0.7         prodlim_2019.11.13
[5] ggplot2_3.3.5      survival_3.2-13   

loaded via a namespace (and not attached):
 [1] pillar_1.6.3       compiler_4.1.1     tools_4.1.1        digest_0.6.28     
 [5] lifecycle_1.0.1    tibble_3.1.5       gtable_0.3.0       lattice_0.20-44   
 [9] pkgconfig_2.0.3    rlang_0.4.11       Matrix_1.3-4       DBI_1.1.1         
[13] parallel_4.1.1     withr_2.4.2        dplyr_1.0.7        generics_0.1.0    
[17] vctrs_0.3.8        globals_0.14.0     stats4_4.1.1       grid_4.1.1        
[21] tidyselect_1.1.1   glue_1.4.2         listenv_0.8.0      R6_2.5.1          
[25] future.apply_1.8.1 fansi_0.5.0        parallelly_1.28.1  lava_1.6.10       
[29] purrr_0.3.4        magrittr_2.0.1     scales_1.1.1       codetools_0.2-18  
[33] ellipsis_0.3.2     splines_4.1.1      assertthat_0.2.1   future_1.22.1     
[37] colorspace_2.0-2   utf8_1.2.2         munsell_0.5.0      crayon_1.4.1
\end{verbatim}

\clearpage

\section{Performing generalized pairwise comparisons (GPC) using the \texttt{BuyseTest} function}
\label{sec:org21e6ccd}
...
endpoint threshold weight total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)   delta
    time     2e+01    0.5      100        37.78          46.54      15.68        0 -0.0877
   karno     1e-12    0.5      100        41.82          44.95      13.24        0 -0.0313
...
\begin{verbatim}
  endpoint threshold weight total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)   delta
1     time     2e+01    0.8      100        37.78          46.54      15.68        0 -0.0877
3    karno     1e-12    0.2      100        41.82          44.95      13.24        0 -0.0313
    Delta CI [2.5% ; 97.5%] p.value
...
\begin{verbatim}
               estimate         se   lower.ci  upper.ci null   p.value
karno_1e-12 -0.03132992 0.09787113 -0.2197111 0.1593037    0 0.7490407
\end{verbatim}
...
\begin{verbatim}
               estimate         se   lower.ci  upper.ci null   p.value
time_20     -0.08765836 0.09760901 -0.2735301 0.1045245    0 0.3716170
karno_1e-12 -0.03132992 0.09787113 -0.2197111 0.1593037    0 0.7490407
\end{verbatim}
...
1    0.00000 -0.08752774 0.10041203 -0.27851884 0.11012263    0 -0.32473925  0.1600436
2   55.55556 -0.08095829 0.08957699 -0.25229456 0.09530004    0 -0.29422328  0.1399865
3  111.11111 -0.03170177 0.07463991 -0.17629003 0.11422560    0 -0.21242118  0.1511145
4  166.66667  0.01896964 0.06452954 -0.10713643 0.14447503    0 -0.13908828  0.1760851
5  222.22222  0.03315614 0.05523512 -0.07506821 0.14060850    0 -0.10264068  0.1677397
6  277.77778  0.04217485 0.04654025 -0.04914025 0.13279075    0 -0.07248700  0.1557364
7  333.33333  0.04112991 0.03946828 -0.03631838 0.11808708    0 -0.05614705  0.1376333
8  388.88889  0.04075638 0.03300933 -0.02402114 0.10519310    0 -0.04062269  0.1215983
9  444.44444  0.04097871 0.03027888 -0.01844156 0.10011054    0 -0.03367577  0.1151785
10 500.00000  0.03517173 0.02769280 -0.01915553 0.08929191    0 -0.03308244  0.1030994
\end{verbatim}
