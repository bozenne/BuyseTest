...
The argument \texttt{n.grid} controls how many points are used to discretise
the survival curve.

\subsection{Correction via re-weighting \citep{peron2021correcting}}
\label{sec:org0014cac}

\subsubsection{At the trial level}
\label{sec:org7a6b92c}
