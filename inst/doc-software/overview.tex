...
[1] data.table_1.14.0  BuyseTest_2.3.5    Rcpp_1.0.6         prodlim_2019.11.13
[5] ggplot2_3.3.5      survival_3.2-13   

loaded via a namespace (and not attached):
 [1] magrittr_2.0.1   splines_4.1.1    tidyselect_1.1.1 munsell_0.5.0    colorspace_2.0-2
 [6] lattice_0.20-44  R6_2.5.0         rlang_0.4.11     fansi_0.5.0      dplyr_1.0.7     
[11] parallel_4.1.1   grid_4.1.1       gtable_0.3.0     utf8_1.2.1       withr_2.4.2     
[16] ellipsis_0.3.2   tibble_3.1.2     lifecycle_1.0.0  crayon_1.4.1     Matrix_1.3-4    
[21] lava_1.6.9       purrr_0.3.4      vctrs_0.3.8      glue_1.4.2       compiler_4.1.1  
[26] pillar_1.6.1     generics_0.1.0   scales_1.1.1     stats4_4.1.1     pkgconfig_2.0.3
\end{verbatim}

\clearpage

\section{Performing generalized pairwise comparisons (GPC) using the \texttt{BuyseTest} function}
\label{sec:org5b4913d}
