...
[1] data.table_1.16.2  prodlim_2024.06.25 ggplot2_3.5.1      BuyseTest_3.2.0   
[5] Rcpp_1.0.13        survival_3.5-8    
...
[25] grid_4.3.3          pbapply_1.7-2       lifecycle_1.0.4     lava_1.8.0         
[29] vctrs_0.6.5         SparseM_1.81        glue_1.8.0          listenv_0.9.1      
[33] codetools_0.2-19    stats4_4.3.3        parallelly_1.38.0   fansi_1.0.6        
[37] colorspace_2.1-1    tools_4.3.3         pkgconfig_2.0.3
\end{verbatim}

\clearpage

\section{Performing generalized pairwise comparisons (GPC)}
\label{sec:org3d63f24}
...
\end{itemize}
have been recommended (e.g. \cite{ajufo2023fallacies}) and these summary
...
\Warning The pooled estimator presented in this section have a
...
strata. Instead one should estimate a net treatment benefit for each
...
1              global 100.000000 -0.11874500 -0.118745 -0.2843405 0.0537305 0.1767059
...
\uline{Note:} while it is possible to extract the strata-specific estimate
(e.g. \texttt{coef(BTstd, strata = TRUE)}) the software does not keep track
of the strata-specific uncertainty via the H-decomposition. It will
output an error message when requesting it (e.g. \texttt{confint(BTstd,
strata = TRUE)}). A resampling method should be used instead.

\subsection{Using multiple endpoints}
\label{sec:org0147f4c}
