...
other attached packages:
 [1] prodlim_2019.11.13 ggplot2_3.3.5      survival_3.2-13    BuyseTest_2.3.5   
 [5] spelling_2.2       roxygen2_7.1.1     butils.base_1.2    Rcpp_1.0.7        
 [9] data.table_1.14.2  devtools_2.4.2     usethis_2.0.1     

loaded via a namespace (and not attached):
  [1] TH.data_1.1-0             colorspace_2.0-2          ellipsis_0.3.2           
  [4] rprojroot_2.0.2           htmlTable_2.2.1           RcppArmadillo_0.10.7.0.0 
  [7] base64enc_0.1-3           fs_1.5.0                  rstudioapi_0.13          
 [10] farver_2.1.0              listenv_0.8.0             MatrixModels_0.5-0       
 [13] remotes_2.4.0             fansi_0.5.0               mvtnorm_1.1-3            
 [16] xml2_1.3.2                codetools_0.2-18          splines_4.1.1            
 [19] doParallel_1.0.16         cachem_1.0.6              knitr_1.36               
 [22] pkgload_1.2.1             Formula_1.2-4             cluster_2.1.2            
 [25] png_0.1-7                 riskRegression_2021.10.08 compiler_4.1.1           
 [28] backports_1.2.1           assertthat_0.2.1          Matrix_1.3-4             
 [31] fastmap_1.1.0             cli_3.0.1                 htmltools_0.5.2          
 [34] quantreg_5.86             prettyunits_1.1.1         tools_4.1.1              
 [37] gtable_0.3.0              glue_1.4.2                dplyr_1.0.7              
 [40] vctrs_0.3.8               nlme_3.1-152              conquer_1.0.2            
 [43] iterators_1.0.13          xfun_0.26                 stringr_1.4.0            
 [46] globals_0.14.0            ps_1.6.0                  testthat_3.0.4           
 [49] lifecycle_1.0.1           future_1.22.1             polspline_1.1.19         
 [52] MASS_7.3-54               zoo_1.8-9                 scales_1.1.1             
 [55] parallel_4.1.1            sandwich_3.0-1            SparseM_1.81             
 [58] RColorBrewer_1.1-2        memoise_2.0.0             gridExtra_2.3            
 [61] rms_6.2-0                 rpart_4.1-15              latticeExtra_0.6-29      
 [64] stringi_1.7.5             desc_1.3.0                foreach_1.5.1            
 [67] checkmate_2.0.0           pkgbuild_1.2.0            lava_1.6.10              
 [70] mets_1.2.9                rlang_0.4.11              pkgconfig_2.0.3          
 [73] matrixStats_0.61.0        lattice_0.20-44           purrr_0.3.4              
 [76] htmlwidgets_1.5.4         labeling_0.4.2            cmprsk_2.2-10            
 [79] processx_3.5.2            tidyselect_1.1.1          parallelly_1.28.1        
 [82] magrittr_2.0.1            R6_2.5.1                  generics_0.1.0           
 [85] Hmisc_4.6-0               multcomp_1.4-17           DBI_1.1.1                
 [88] pillar_1.6.3              foreign_0.8-81            withr_2.4.2              
 [91] nnet_7.3-16               tibble_3.1.5              future.apply_1.8.1       
 [94] crayon_1.4.1              utf8_1.2.2                timereg_2.0.0            
 [97] jpeg_0.1-9                grid_4.1.1                callr_3.7.0              
[100] digest_0.6.28             numDeriv_2016.8-1.1       stats4_4.1.1             
...
#+begin_example
 ...
 -0.0877  [-0.2776;0.1039] 0.36977 
 -0.1190  [-0.4534;0.2222] 0.49514
#+end_example
...
1    0.00000 -0.08752774 0.10041203 -0.27851884 0.11012263    0 -0.32433538  0.1596037
2   55.55556 -0.08095829 0.08957699 -0.25229456 0.09530004    0 -0.29385580  0.1395921
3  111.11111 -0.03170177 0.07463991 -0.17629003 0.11422560    0 -0.21210288  0.1507888
4  166.66667  0.01896964 0.06452954 -0.10713643 0.14447503    0 -0.13880586  0.1758060
5  222.22222  0.03315614 0.05523512 -0.07506821 0.14060850    0 -0.10239659  0.1675000
6  277.77778  0.04217485 0.04654025 -0.04914025 0.13279075    0 -0.07228010  0.1555335
7  333.33333  0.04112991 0.03946828 -0.03631838 0.11808708    0 -0.05597123  0.1374603
8  388.88889  0.04075638 0.03300933 -0.02402114 0.10519310    0 -0.04047542  0.1214530
9  444.44444  0.04097871 0.03027888 -0.01844156 0.10011054    0 -0.03354062  0.1150449
10 500.00000  0.03517173 0.02769280 -0.01915553 0.08929191    0 -0.03295888  0.1029770
#+end_example
...
#+RESULTS:
#+begin_example
Fejl i grDevices::pdf(file = filename, ..., version = version) : 
  kan ikke åbne fil 'figures/gg-sensitivity1.pdf'
1: BuyseTest(treatment ~ tte(eventtime, status, threshold = 0.5), 
       model.tte = e.survreg, data = dt, scoring.rule = "Peron", 
       trace = 0)
2: do.call("S4BuyseTest", args = c(list(call = setNames(as.list(mycall), 
       names(mycall))), outPoint, outArgs[keep.args], outResampling)) at BuyseTest.R#445
3: S4BuyseTest(call = list(BuyseTest, formula = treatment ~ tte(eventtime, 
       status, threshold = 0.5), data = dt, scoring.rule = "Peron", 
       model.tte = e.survreg, trace = 0), count_favorable = structure(28505.426661134, .Dim = c(1L, 
   1L)), count_unfavorable = structure(82110.1715616352, .Dim = c(1L, 
   1L)), count_neutral = structure(139364.29756625, .Dim = c(1L, 
    ...
4: new("S4BuyseTest", ...) at S4-BuyseTest.R#291
5: initialize(value, ...)
6: initialize(value, ...)
7: .local(.Object, ...)
8: (function (cl, name, valueClass) 
   {
       ClassDef <- getClass(cl)
       slotClass <- ClassDef@slots[[name]]
       if (is.null(slotClass)) 
    ... at S4-BuyseTest.R#263
9: getClass(cl)
...
#+RESULTS:
: Fejl i grDevices::pdf(file = filename, ..., version = version) : 
:   kan ikke åbne fil 'figures/gg-sensitivity2.pdf'
: 1: ggsave(autoplot(BTse.ustat), filename = file.path("figures", 
:        "gg-sensitivity1.pdf"), width = 5, height = 3)
...
#+END_SRC
#+RESULTS:
: Fejl i pdf(file.path("figures", "plot-crossingSurv.pdf"), width = 10) : 
:   kan ikke åbne fil 'figures/plot-crossingSurv.pdf'
: 1: ggsave(autoplot(BTse.H, col = NA), filename = file.path("figures", 
:        "gg-sensitivity2.pdf"), width = 7, height = 3)
: 2: dev(filename = filename, width = dim[1], height = dim[2], bg = bg, 
:        ...)
: 3: grDevices::pdf(file = filename, ..., version = version)
: null device 
...
#+begin_example
 ...
 endpoint threshold n.T n.C mean.estimate
        Y     1e-12   5   5        0.2425
                     10  10        0.2526
                     20  20        0.2469
                     30  30        0.2488
