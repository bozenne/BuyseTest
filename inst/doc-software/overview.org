...
See =help(S4BuyseTest-summary)= for more details about the =summary=
...
method displays strata-specific and global results[fn::the
...
pairs. This behavior can be changed with the argument =pool.strata=:
...
:   - Univariate tests:
:               estimate se    lower.ci    upper.ci null p.value  lower.band  upper.band
: hierchical -0.10092285  0 -0.10092285 -0.10092285    0       0 -0.10092285 -0.10092285
: Obrien     -0.05949414  0 -0.05949414 -0.05949414    0       0 -0.05949414 -0.05949414
:            adj.p.value
: hierchical           0
: Obrien               0
