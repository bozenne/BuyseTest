...
indicates how pairs involving missing data are compared:
    ...
    + *the Peron's scoring rule* compares the probabilty of one
      ...
      stratified on treatment and GPC =strata= variable (if any).
...
Uninformative score will typicall arise with the Gehan's scoring rule
  ...
  towards 0 [fn::While the power is typically reduced, the type 1
...
: 1 eventtime       0.5   100  13.52321    41.34697 45.12977 4.310969e-05
:        Delta   lower.ci   upper.ci      p.value
: 1 -0.2782376 -0.4193279 -0.1240234 0.0005078037
