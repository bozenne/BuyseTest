...
\label{sec:orgd949be1}
\subsection{Theory}
\label{sec:org39511b4}

\subsubsection{General case (no censoring)}
\label{sec:org1f2261e}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:orgb0ce90b}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orgfd7e54b}
...
\label{sec:org956a033}

\subsubsection{Binary endpoint}
\label{sec:org30b1cce}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
