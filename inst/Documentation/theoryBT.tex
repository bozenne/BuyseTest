...
\label{sec:org7c56f95}
\subsection{Theory}
\label{sec:org618fa29}

\subsubsection{General case (no censoring)}
\label{sec:orgab2a508}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org8b3b299}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orgbb2370e}
...
\label{sec:orgebc0fbc}

\subsubsection{Binary endpoint}
\label{sec:org2ac4695}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
