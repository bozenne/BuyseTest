...
\label{sec:orgd9a195f}
\subsection{Theory}
\label{sec:org3884a17}

\subsubsection{General case (no censoring)}
\label{sec:org82d7e8e}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org8bd38ac}

\subsubsection{BuyseTest (no censoring)}
\label{sec:org30e3e30}
...
\label{sec:orgd6530d4}

\subsubsection{Binary endpoint}
\label{sec:org4358428}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
