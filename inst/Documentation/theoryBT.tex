...
\label{sec:orgb90a61d}
\subsection{Theory}
\label{sec:org3b90ed2}

\subsubsection{General case (no censoring)}
\label{sec:org1551c5b}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:orgeb5146f}

\subsubsection{BuyseTest (no censoring)}
\label{sec:org7b3cdc2}
...
\label{sec:org1c923ed}

\subsubsection{Binary endpoint}
\label{sec:org5f45500}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
...
\begin{align*}
\frac{1}{(mn)^2} \sum_{i=1}^n \sum_{j=1}^m \Cov\left[U_{1,ij},U_{2,ij}\right] 
&=  \frac{1}{(mn)^2} \sum_{i=1}^n \sum_{j=1}^m \Var\left[\sqrt{U_{1,ij}U_{2,ij}}\right] \\
&=  \Var\left[\frac{1}{mn} \sum_{i=1}^n \sum_{j=1}^m \sqrt{U_{1,ij}U_{2,ij}}\right] \\
&\approx \left(\frac{1}{mn} \sum_{i=1}^n \sum_{j=1}^m \sqrt{U_{1,ij}U_{2,ij}}\right)\left(1-\frac{1}{mn} \sum_{i=1}^n \sum_{j=1}^m \sqrt{U_{1,ij}U_{2,ij}}\right)
\end{align*}
