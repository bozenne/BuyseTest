...
\label{sec:org7e7b415}
\subsection{Theory}
\label{sec:orgc300c98}

\subsubsection{General case (no censoring)}
\label{sec:org99ed9f1}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org5969d74}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orge128f98}
