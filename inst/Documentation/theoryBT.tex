...
\label{sec:org7655dc6}
\subsection{Theory}
\label{sec:orgfef2d42}

\subsubsection{General case (no censoring)}
\label{sec:orgab2b5ce}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:orgef823f5}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orgc873ee7}
...
\label{sec:orgc2b0e90}

\subsubsection{Binary endpoint}
\label{sec:org1908956}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
