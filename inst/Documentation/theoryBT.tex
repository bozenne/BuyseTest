...
\label{sec:orge0ec4d6}
\subsection{Theory}
\label{sec:org16c7d2b}

\subsubsection{General case (no censoring)}
\label{sec:orgae09eb0}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org3a09c75}

\subsubsection{BuyseTest (no censoring)}
\label{sec:org7920636}
