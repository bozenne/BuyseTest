...
\label{sec:orgb0c2ef1}
\subsection{Theory}
\label{sec:org1dcf78d}

\subsubsection{General case (no censoring)}
\label{sec:org595aa7e}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org3cb6987}

\subsubsection{BuyseTest (no censoring)}
\label{sec:org4526915}
