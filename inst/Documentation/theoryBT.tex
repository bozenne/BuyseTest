...
\label{sec:orge1e8b16}
\subsection{Theory}
\label{sec:org8864e2e}

\subsubsection{General case (no censoring)}
\label{sec:org84a22c9}
Let consider: 
\begin{itemize}
...
\subsection{In R}
\label{sec:org202ae7a}

\subsubsection{BuyseTest (no censoring)}
\label{sec:orgc2917ce}
...
\label{sec:orgbbf1586}

\subsubsection{Binary endpoint}
\label{sec:orgd3f533e}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
tpsBin <- system.time(
