...
#' 
#' @description Display the main results stored in a \code{BuyseSim} object.
#' 
#' @param object an \R object of class \code{BuyseSim}, i.e., output of \code{\link{BuyseTest}}
#' 
#' @seealso 
